...
class build_transformer(nn.Module):
    ...
    def encode_text(self, text):
        ...
        return text_features, global_feat_text

    def forward(self, image, text=None, label=None, cam_label=None, view_label=None, modality=None, use_mask=None, prob=0.0):
        ...
        image_features = self.base.encode_image(image, cv_embed, modality, text_inverse=None, use_mask=use_mask, prob=prob)
        global_feat_img = image_features[:, 0]

        return_values = image_features[:, 1:-1] if self.inverse else image_features[:, 1:]
        return return_values, global_feat_img
